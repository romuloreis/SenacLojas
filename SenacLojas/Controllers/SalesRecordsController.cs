...
namespace SenacLojas.Controllers
{
    ...
    {
        private readonly SenacLojasContext _context;

        public SalesRecordsController(SenacLojasContext context)
        {
            _context = context;
        }
        ...
        {
            var senacLojasContext = _context.SalesRecord.Include(s => s.Seller);
            return View(await senacLojasContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SenacLojasContext.SalesRecord'  is null.");
            }
            var salesRecord = await _context.SalesRecord.FindAsync(id);
            if (salesRecord != null)
            {
